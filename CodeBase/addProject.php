		...
		<div  id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					<h2>
					<?php
					echo (isset($_GET['CompanyID'])?'Update Company':'Add Company');
					?></h2>
					<?php 
					echo "<form action='addComp.php".(isset($_GET['CompanyID'])? "?CompanyID=".$_GET['CompanyID'] : "")."' method='post'>";
					?>
<!--Merchandise ID: <input type="text" name="MerchID"><br></br>-->

<?php
if(isset($_GET['CompanyID'])){
	$_SESSION['CompanyID'] = $CompanyID=$_GET['CompanyID'];

	$mysqlquery1="Select * from company where CompanyID = '$CompanyID'";
	...
	echo "Bussiness Name: <input type='text' name='BusinessName' value ='".$BusinessName."'><br /><br />";      
	echo "Address: <input type='text' name='Address' value='".$Address."'><br /><br />";
	echo "City: <input type='text' name='City' value='".$City."'><br /><br />";
	echo "State: <input type='text' name='State' value=".$State."><br /><br />";
	echo "Zip Code: <input type='text' name='Zip' value=".$Zip."><br /><br />";
	echo "Phone Number: <input type='text' name='Phone' value=".$Phone."><br /><br />";
	echo "Fax Number: <input type='text' name='Fax' value=".$Fax."><br /><br />";
	echo "Contact Name: <input type='text' name='ContactName' value='".$ContactName."'><br /><br />";
}	

else{
		echo "Bussiness Name: <input type='text' name='BusinessName'><br /><br />";
		...
		echo "Fax Number: <input type='text' name='Fax'><br /><br />";
		echo "Contact Name: <input type='text' name='ContactName'><br /><br />";
	}
?>
<input type="submit">
</form>
