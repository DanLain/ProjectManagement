		...
		<div  id="main" class="shell">
			...
			<div id="content">
				<div class="post">
					<h2>
					<?php
					echo (isset($_GET['ProjectID'])?'Update Project':'Add Project');
					?></h2>
					<?php 
					echo "<form action='projectInsertUpdate.php".(isset($_GET['ProjectID'])? "?ProjectID='".$_GET['ProjectID']: "")."' method='post'>";
					?>

						<?php
						if(isset($_GET['ProjectID'])){
								$mysqlquery1="Select * from project where ProjectID = '$_GET[ProjectID]'";
								$result1=mysql_query($mysqlquery1);
								while ($row=mysql_fetch_array($result1)){
										$ProjectID = $row['ProjectID'];
										$Name = $row['ProjectName'];
										$StartDate = $row['TargetStartDate'];
										$EndDate = $row['TargetEndDate'];
										$BudgetDays = $row['BudgetDays'];
										$BudgetCurancy = $row['BudgetCurancy'];
										//$InitialStoryPoints = $row['InitialStoryPoints'];
										//$Locked = $row['Locked'];
								}
								
								
								echo "Project Name: <input type='text' name='Name' value ='".$Name."'><br /><br />";
								echo "Project ID: <input type='text' name='ProjectID' value ='".$ProjectID."'><br /><br />";
								echo "Start Date: <input type='date' name='StartDate' value='".$StartDate."'><br /><br />";
								echo "End Date: <input type='date' name='EndDate' value='".$EndDate."'><br /><br />";
								echo "Budget Days: <input type='text' name='BudgetDays' value ='".$BudgetDays."'><br /><br />";
								echo "Budget Curancy: <input type='text' name='BudgetCurancy' value ='".$BudgetCurancy."'><br /><br />";
								...
								echo "Budget Days: <input type='text' name='BudgetDays'><br /><br />";echo "Budget Curancy: <input type='text' name='BudgetCurancy' ><br /><br />";
							}
						?>
						<input type="submit">
					</form>
